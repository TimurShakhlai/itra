...
export default function Auth(props){
    ...
    return(
        <div className="background blue">
            <button className="btn btn-primary" disabled={loading}>Home</button>
            <button className="btn btn-primary" disabled={loading} onClick='/client/src/Pages/ReadOnly'>Read only</button>
            <div className="container row mt-5">
                <div className="col-5 card">
                    <form>
                        ...
                        <div className="card-footer">
                            <button className="btn btn-primary" disabled={loading} onClick={loginHandler}>Sign in</button>
                        </div>
                    </form>
                </div>
                ...
                <div className="col-5 card">
                    <form>
                        ...
                        <div className="card-footer">
                            <button className="btn btn-primary" disabled={loading} onClick={registrationHandler}>Register</button>
                        </div>
                    </form>
                </div>
            </div>
